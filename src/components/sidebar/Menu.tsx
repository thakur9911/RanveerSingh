...
const Menu: FC<MenuProps> = ({}) => {
  ...
  return (
    ...
    >
      ...
      <List
        target="_blank"
        link="https://www.instagram.com/satyam_singh_9911_/"
        effect="slideUp"
      >
        <Instagram color="#b5179e" /> Instagram
      </List>
      <List target="_blank" link="https://github.com/thakur9911" effect="slideUp">
      ...
      <List
        target="_blank"
        link="https://www.linkedin.com/in/ranveer-singh-921681253/"
        effect="slideUp"
      >
